...
class AlienInvasion:
    def __init__(self):
        ...
        self._create_fleet()
        pygame.display.set_caption("DevaSpaceInvader")

        icon = pygame.image.load("../image/bb.bmp")
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            self.sb.prep_level
            self.sb.prep_ships()
            # get rid of any remainig aliens & bullets
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _check_keydown_events(self, event):
        ...
        # we can also use elif block for K_Left event but
        # if is also fine
    ...
    def _update_bullets(self):
        self.bullets.update()
        # get rid of the old bullets that are disapeared
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            self.sb.prep_ships()
            # get rid pf remaining alien & bullets
            self.aliens.empty()
            self.bullets.empty()
